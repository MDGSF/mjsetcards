...
//花牌的张数: 春夏秋冬，梅兰竹菊
#define MAX_HUA_NUM 8

//兰州麻将中牌数
#define CARD_MAX_COUNT (MAX_XUSHU_NUM*3*4 + MAX_FENG_NUM*4 + MAX_JIAN_NUM*4 + MAX_HUA_NUM*4)
...
//牌的种类数量(万，条，饼，风，箭，花）
#define MJ_TYPE_NUM 6

//牌数
#define MAX_ALL_GANG_COUNT 34

//最大牌面值
#define MAX_CARD 0x58
